SYSTEM_PROMPTS = {
    'symptom_analyzer_prompt': """
                                ...
                                Please mention 'APPROVE' when you are done with your questions and user's response.
                            """,
    ...
    'treatment_planner_prompt': """
                                ...
                                Please mention 'TREATMENT_PLAN_APPROVED' when you curated the full the treatment plan for the user.
                                """
}